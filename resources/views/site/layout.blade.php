...
<body>
                    ...
                    <div class="owl-carousel active-stories-carousel">
                        ...
                        <div class="single-stories-carousel d-flex align-items-center">
                            <div class="stories-thumb">
                                <img class="img-fluid" src="{{asset('site')}}/img/posts/carousel/stories1.jpg" alt="">
                            </div>
                        ...
                        <div class="single-stories-carousel d-flex align-items-center">
                            <div class="stories-thumb">
                                <img class="img-fluid" src="{{asset('site')}}/img/posts/carousel/stories2.jpg" alt="">
                            </div>
                            <div class="stories-details">
                                <h6><a href="">2nd Gen Smoke Alarm <br>
                                        get up from sleep</a></h6>
                        ...
                        <div class="single-stories-carousel d-flex align-items-center">
                            <div class="stories-thumb">
                                <img class="img-fluid" src="{{asset('site')}}/img/posts/carousel/stories3.jpg" alt="">
                            </div>
                            <div class="stories-details">
                                <h6><a href="">2nd Gen Smoke Alarm <br>
                                        get up from sleep</a></h6>
                        ...
                        <div class="single-stories-carousel d-flex align-items-center">
                            <div class="stories-thumb">
                                <img class="img-fluid" src="{{asset('site')}}/img/posts/carousel/stories4.jpg" alt="">
                            </div>
                            <div class="stories-details">
                                <h6><a href="">2nd Gen Smoke Alarm <br>
                                        get up from sleep</a></h6>
                        ...
                        <div class="single-stories-carousel d-flex align-items-center">
                            <div class="stories-thumb">
                                <img class="img-fluid" src="{{asset('site')}}/img/posts/carousel/stories5.jpg" alt="">
                            </div>
                            <div class="stories-details">
                                <h6><a href="">2nd Gen Smoke Alarm <br>
                                        get up from sleep</a></h6>
                        ...
                        <div class="single-stories-carousel d-flex align-items-center">
                            <div class="stories-thumb">
                                <img class="img-fluid" src="{{asset('site')}}/img/posts/carousel/stories6.jpg" alt="">
                            </div>
                            <div class="stories-details">
                                <h6><a href="">2nd Gen Smoke Alarm <br>
                                        get up from sleep</a></h6>
                    ...
                    <div class="owl-carousel active-post-carusel">
                        ...
                        <div class="single-post-carousel">
                            <div class="post-thumb">
                                <img class="img-fluid" src="{{asset('site')}}/img/posts/carousel/post1.jpg" alt="">
                            </div>
                            <div class="post-details">
                                ...
                                <div class="post-content d-flex justify-content-between">
                                    <div class="post-meta">
                                        <div class="thumb"><img src="{{asset('site')}}/img/author/a1.png" alt=""></div>
                                        <div class="c-desc">
                                            <h6>Marvel Maison</h6>
                        ...
                        <div class="single-post-carousel">
                            <div class="post-thumb">
                                <img class="img-fluid" src="{{asset('site')}}/img/posts/carousel/post2.jpg" alt="">
                            </div>
                            <div class="post-details">
                                <h2><a href="#">2nd Gen Smoke Alarm get up <br>
                                        from sleep Daily</a></h2>
                        ...
                        <div class="single-post-carousel">
                            <div class="post-thumb">
                                <img class="img-fluid" src="{{asset('site')}}/img/posts/carousel/post3.jpg" alt="">
                            </div>
                            <div class="post-details">
                                <h2><a href="#">2nd Gen Smoke Alarm get up <br>
                                        from sleep Daily</a></h2>
            ...
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="single-post-item">
                                    <div class="post-thumb">
                                        <img class="img-fluid" src="{{asset('site')}}/img/archive/c1.jpg" alt="">
                                    </div>
                                    <div class="post-details">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-post-item">
                                    <div class="post-thumb">
                                        <img class="img-fluid" src="{{asset('site')}}/img/archive/c2.jpg" alt="">
                                    </div>
                                    <div class="post-details">
                                        <h4><a href="#">An Stormy Evening</a></h4>
                                        <p>There is a moment in the life of any aspiring astronomer that it is time to
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-post-item">
                                    <div class="post-thumb">
                                        <img class="img-fluid" src="{{asset('site')}}/img/archive/c3.jpg" alt="">
                                    </div>
                                    <div class="post-details">
                                        <h4><a href="#">An Stormy Evening</a></h4>
                                        <p>There is a moment in the life of any aspiring astronomer that it is time to
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-post-item">
                                    <div class="post-thumb">
                                        <img class="img-fluid" src="{{asset('site')}}/img/archive/c4.jpg" alt="">
                                    </div>
                                    <div class="post-details">
                                        <h4><a href="#">An Stormy Evening</a></h4>
                                        <p>There is a moment in the life of any aspiring astronomer that it is time to
                ...
                <div class="col-lg-4 sidebar">
                    <div class="single-widget protfolio-widget">
                        ...
                        <img src="{{asset('site')}}/img/sign.png" alt="">
                    </div>
                                ...
                                <div class="jq-tab-content active" data-tab="1">
                                    <div class="single-popular-post d-flex flex-row">
                                        <div class="popular-thumb">
                                            <img class="img-fluid"
                                                src="{{asset('site')}}/img/posts/carousel/stories1.jpg" alt="">
                                        </div>
                                    ...
                                    <div class="single-popular-post d-flex flex-row">
                                        <div class="popular-thumb">
                                            <img class="img-fluid"
                                                src="{{asset('site')}}/img/posts/carousel/stories2.jpg" alt="">
                                        </div>
                                        <div class="popular-details">
                                            <h6><a href="">2nd Gen Smoke Alarm <br>
                                                    get up from sleep</a></h6>
                                    ...
                                    <div class="single-popular-post d-flex flex-row">
                                        <div class="popular-thumb">
                                            <img class="img-fluid"
                                                src="{{asset('site')}}/img/posts/carousel/stories3.jpg" alt="">
                                        </div>
                                        <div class="popular-details">
                                            <h6><a href="">2nd Gen Smoke Alarm <br>
                                                    get up from sleep</a></h6>
                                    ...
                                    <div class="single-popular-post d-flex flex-row">
                                        <div class="popular-thumb">
                                            <img class="img-fluid"
                                                src="{{asset('site')}}/img/posts/carousel/stories4.jpg" alt="">
                                        </div>
                                        <div class="popular-details">
                                            <h6><a href="">2nd Gen Smoke Alarm <br>
                                                    get up from sleep</a></h6>
                        ...
                        <ul>
                            <li>
                                <a href="#" class="justify-content-between align-items-center d-flex">
                                    <p><img src="{{asset('site')}}/img/bullet.png" alt="">International (56)</p>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="justify-content-between align-items-center d-flex">
                                    <p><img src="{{asset('site')}}/img/bullet.png" alt="">Tours and Travels (45)</p>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="justify-content-between align-items-center d-flex">
                                    <p><img src="{{asset('site')}}/img/bullet.png" alt="">Cooking Tips (23)</p>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="justify-content-between align-items-center d-flex">
                                    <p><img src="{{asset('site')}}/img/bullet.png" alt="">Life Style and Fashion (72)
                                    </p>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="justify-content-between align-items-center d-flex">
                                    <p><img src="{{asset('site')}}/img/bullet.png" alt="">Organic News (37)</p>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="justify-content-between align-items-center d-flex">
                                    <p><img src="{{asset('site')}}/img/bullet.png" alt="">Games and Sports (19)</p>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-footer-widget instafeed">
                        ...
                        <ul class="list instafeed d-flex flex-wrap">
                            <li><img src="{{asset('site')}}/img/i1.jpg" alt=""></li>
                            <li><img src="{{asset('site')}}/img/i2.jpg" alt=""></li>
                            <li><img src="{{asset('site')}}/img/i3.jpg" alt=""></li>
                            <li><img src="{{asset('site')}}/img/i4.jpg" alt=""></li>
                            <li><img src="{{asset('site')}}/img/i5.jpg" alt=""></li>
                            <li><img src="{{asset('site')}}/img/i6.jpg" alt=""></li>
                            <li><img src="{{asset('site')}}/img/i7.jpg" alt=""></li>
                            <li><img src="{{asset('site')}}/img/i8.jpg" alt=""></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row footer-bottom d-flex justify-content-between align-items-center">
                <p class="col-lg-12 footer-text text-center">
                    ...
                    document.write(new Date().getFullYear());
                        ...
                        aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib ---
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.{{asset('site')}}/js/1.12.9/umd/popper.min.js"
